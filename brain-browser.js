(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('./gpu.min.js'))
    : typeof define === 'function' && define.amd
      ? define(['exports', './gpu.min.js'], factory)
  ...
  const relu$2 = /* #__PURE__ */Object.freeze({
    __proto__: null,
    activate: activate$3,
    measure: measure$3
  })
  ...
  const sigmoid$2 = /* #__PURE__ */Object.freeze({
    __proto__: null,
    activate: activate$2,
    measure: measure$2
  })
  ...
  const tanh$2 = /* #__PURE__ */Object.freeze({
    __proto__: null,
    activate: activate$1,
    measure: measure$1
  })
  ...
  const leakyRelu$1 = /* #__PURE__ */Object.freeze({
    __proto__: null,
    activate,
    measure
  })
  ...
  class FeedForward {
    ...
    toJSON () {
      ...
      return {
        ...
        sizes: (_a = this.options.sizes) !== null && _a !== void 0
          ? _a
    ...
    static fromJSON (json, getLayer) {
      ...
      const inputLayer = getLayer
        ? (_a = layerFromJSON(jsonLayers[0])) !== null && _a !== void 0 ? _a : getLayer(jsonLayers[0])
      ...
      for (let i = 1; i < jsonLayers.length; i++) {
        ...
        if (typeof jsonLayer.inputLayerIndex === 'undefined' &&
          ...
          const layer = getLayer
            ? (_b = layerFromJSON(jsonLayer)) !== null && _b !== void 0 ? _b : getLayer(jsonLayer)
          ...
          const layer = getLayer
            ? (_c = layerFromJSON(jsonLayer, inputLayer)) !== null && _c !== void 0 ? _c : getLayer(jsonLayer, inputLayer)
          ...
          const layer = getLayer
            ? (_d = layerFromJSON(jsonLayer, inputLayer1, inputLayer2)) !== null && _d !== void 0 ? _d : getLayer(jsonLayer, inputLayer1, inputLayer2)
  ...
  const browser = createCommonjsModule(function (module, exports) {
     ...
     */
    const Thaw = /** @class */ (function () {
      function Thaw (items, options) {
        const _this = this
        if (options === void 0) { options = {} }
        const _a = __assign(__assign({}, Thaw.defaultSettings), options); const each = _a.each; const done = _a.done
        this.i = 0
        ...
        this.tick = function () {
          ...
          const item = _this.items[_this.i]
  ...
  class Recurrent extends FeedForward {
    ...
    run (inputs) {
      ...
      if (result instanceof gpu_js.Texture) { return result.toArray() }
      return result
    }
